...
const uint16_t OV5640_jpeg_reg_tbl[][2]=
{
	...
	0x501f, 0x00, // YUV 422
	// Input clock = 24Mhz
	0x3035, 0x14, // Giảm bộ chia Clock hệ thống
	0x3036, 0x80, // Tăng hệ số nhân PLL	
	...
	// 3. ĐIỀU CHỈNH ĐẦU RA CHUẨN QVGA (320x240)
    0x3808, 0x01, // DVPHO High (320 = 0x0140)
    0x3809, 0x40, // DVPHO Low
    0x380a, 0x00, // DVPVO High (240 = 0x00F0)
    0x380b, 0xf0, // DVPVO Low

    // 4. HẠ VTS XUỐNG 0x03D8 (Do Sub-sampling giúp giảm 1/2 số dòng quét silicon)
    0x380c, 0x0b, // HTS High
    0x380d, 0x1c, // HTS Low
    0x380e, 0x03, // VTS High (0x03D8 = 984 lines -> Khung hình chạy 30 FPS)
    0x380f, 0xd8, // VTS Low

	
	0x3813, 0x04, // timing V offset   04
	// 2. BẬT 2x2 SUB-SAMPLING (BINNING) - QUAN TRỌNG NHẤT ĐỂ TĂNG FPS
    0x3814, 0x31, // Timing X Inc -> Sub-sampling 2x2
    0x3815, 0x31, // Timing Y Inc -> Sub-sampling 2x2
	0x3618, 0x04,
	0x3612, 0x2b,
	0x3709, 0x12,
	0x370c, 0x00,
