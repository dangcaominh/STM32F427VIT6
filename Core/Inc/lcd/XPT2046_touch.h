...
#define XPT2046_IRQ_Pin       	LCD_INT_Pin
#define XPT2046_IRQ_GPIO_Port 	LCD_INT_GPIO_Port
#define XPT2046_CS_Pin        	LCD_NCS_Pin
#define XPT2046_CS_GPIO_Port  	LCD_NCS_GPIO_Port
